...
INSERT INTO Estudiante (idEstudiante, nombre, email, contrasena, carrera)
VALUES (1, 'Maria', 'maria@madas.com', '1234', 'Ingeniería en Alimentos'),
...
VALUES (0, 'Administrador', 'admin@gmail.com', '4321');

-- Insertar datos en la tabla Seleccion
INSERT INTO Seleccion (nombre)
VALUES ('Argentina'),
       ('Bolivia'),
       ('Brasil'),
       ('Canadá'),
...
INSERT INTO Partido (nombreSeleccionLocal, nombreSeleccionVisitante, fecha, golLocal, golVisitante)
VALUES ('Argentina', 'Canadá', '2024-06-20 21:00:00', NULL, NULL),
...
INSERT INTO Estudiante_Realiza_Prediccion (idEstudiante, nombreSeleccionLocal, nombreSeleccionVisitante, fecha,
                                           golLocal, golVisitante, puntaje)
VALUES (1, 'Argentina', 'Canadá', '2024-06-20 21:00:00', 1, 8, 0),
       (1, 'Perú', 'Chile', '2024-06-21 21:00:00', 1, 6, 0);

-- Insertar datos en la tabla Estudiante_Elige_Seleccion
INSERT INTO Estudiante_Elige_Seleccion (idEstudiante, nombreSeleccion, eleccion)
VALUES (1, 'Argentina', 'Campeón'),
       (1, 'Brasil', 'Subcampeón');